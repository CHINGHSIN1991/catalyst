...
Use chrome.storage API to implement page communication function. Features to reset authorization button, use pronunciation tool (not yet stable)<br>- released @GitHub 2022/10/22
