...
## Version History
- [ v1.0.8 ]  Fixed bugs caused by typescript and some functions that were called repeatedly.Installed the missed typeScript helper package. Adjusted the structure of package.json.<br>- released @GitHub 2022/11/01
