...
export const PageToolPanel: React.FC<{}> = () => {
  ...
  function updateIsShow() {
    const tempPersonalization = { ...personalization, isPageToolShow: !personalization.isPageToolShow };
  ...
  return (
    <PageToolContainer>
      ...
      <PublicOptionSet onClick={updateIsShow}>
        <PublicOptionBg bol={personalization ? personalization.isPageToolShow : true}></PublicOptionBg>
        <PublicOption bol={personalization ? personalization.isPageToolShow : true}>Show</PublicOption>
        <PublicOption bol={!(personalization ? personalization.isPageToolShow : true)}>Hidden</PublicOption>
      </PublicOptionSet>
    </PageToolContainer>
  );
};
