    ...
    <Wrapper centralPanel={props.centralPanel}>
      ...
      {weatherData && (
        <WeatherInfoContainer>
          ...
          <MainInfo>
            {!personalization.isCelsius && (
              <MainDegree>{`${standerToFahrenheit(
                weatherData.main.temp
              )} ℉`}</MainDegree>
            )}
            {personalization.isCelsius && (
              <MainDegree>{`${standerToMetric(
                weatherData.main.temp
              )} ℃`}</MainDegree>
            )}
          ...
          <MainInfo>
            ...
            <Info>
              ...
              {!personalization.isCelsius &&
                `${standerToFahrenheit(weatherData.main.feels_like)} ℉`}
              {personalization.isCelsius &&
                `${standerToMetric(weatherData.main.feels_like)} ℃`}
            </Info>
            <Info>
              ...
              {!personalization.isCelsius &&
                ...
                )} - ${standerToFahrenheit(weatherData.main.temp_max)} ℉`}
              {personalization.isCelsius &&
                `${standerToMetric(
                  weatherData.main.temp_min
                )} - ${standerToMetric(weatherData.main.temp_max)} ℃`}
            </Info>
          </MainInfo>
        </WeatherInfoContainer>
      )}
