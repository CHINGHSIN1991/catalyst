...
import {
  ...
  deleteShortcut,
  loadShortcuts,
} from '../features/reducers/shortcutsSlice'
  ...
  return (
    <OrgFunctionPanel>
      ...
      <ShortcutsList>
        ...
        <Shortcut
          onClick={() => {
            dispatch(setEditPanel({ name: 'ShortcutAdd' }))
          }}
        >
    ...
    <Shortcut key={props.shortcut.id} onMouseLeave={() => setIsEditOn(false)}>
      ...
      <EditOptionContainer isEditOn={isEditOn}>
        <EditOption1
          ...
          onClick={() => {
            dispatch(
              setEditPanel({ name: 'ShortcutEdit', data: props.shortcut })
            )
          }}
        >
          Edit
        ...
        <EditOption2
          isEditOn={isEditOn}
          onClick={() => {
            dispatch(deleteShortcut(props.shortcut))
          }}
        >
          Delete
        </EditOption2>
