...
export const SettingPanel: React.FC<
  {
    ...
    return (
      <SettingPanelWrapper>
        ...
        <ButtonContainer>
          <ButtonArea title="Option page" onClick={() => setIsPanelOpen(true)}>
          ...
          <ButtonArea title="User information" onClick={() => setIsPanelOpen(true)}>
          ...
          <ButtonArea title="Background setting" onClick={() => setIsPanelOpen(true)}>
          ...
          <ButtonArea title="Pronounce tool" onClick={() => setIsPanelOpen(true)}>
          ...
          <ButtonArea title="Menu setting" onClick={() => setIsPanelOpen(true)}>
          ...
          <ButtonArea title="Display mode" onClick={() => setIsPanelOpen(true)}>
