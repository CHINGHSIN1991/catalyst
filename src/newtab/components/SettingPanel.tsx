  ...
  return (
    ...
    >
      ...
      <ButtonContainer>
        ...
        <ButtonArea title="Menu setting" onClick={() => { dispatch(setEditPanel({ name: 'MenuOptionEdit' })); }}>
        ...
        <ButtonArea title="Display mode" onClick={() => { dispatch(setEditPanel({ name: 'DisplayModeEdit' })); }}>
