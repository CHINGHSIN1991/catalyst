...
import {
  getEditPanelState,
  setEditPanel,
} from '../../features/reducers/editSlice'
  ...
  function addImgToCollection(image: background, collection: number) {
    ...
    if (
      ...
      setAlertState({
        ...
        message: `This image is already in collection${collection}`,
      })
    }
  }
    ...
    <Wrapper onClick={(e: Event) => e.stopPropagation()}>
            ...
            [0, 1, 2, 3, 4, 5].map((item) => {
              return (
                ...
                >
                  ...
                  {(item === tempBackgroundSetting.bgSetting.current.setting ||
                    item === current) && (
                    <ApplyButton
                    ...
                    >
                      ...
                      {tempBackgroundSetting.bgSetting.current.setting !==
                        item &&
                        tempBackgroundSetting.backgroundList[item].length > 0 &&
                        'Apply'}
                    </ApplyButton>
                  )}
                </BackgroundListOption>
      ...
      <ButtonContainer>
        <PanelButton
          ...
          name="Save"
          onClick={() => {
            dispatch(loadBackgrounds(tempBackgroundSetting))
